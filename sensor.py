...
async def async_setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    sensors = [
        ...
        DeliosSensor(api, "07 Daily energy taken", "daily_energy_grid_taken", "kWh"),
        DeliosSensor(api, "08 Daily energy given", "daily_energy_grid_given", "kWh"),
        DeliosSensor(api, "09 Daily energy PV", "daily_energy_pv", "kWh"),
        DeliosSensor(api, "10 Daily energy battery discharge", "daily_energy_batt_dischar", "kWh"),
        DeliosSensor(api, "11 Daily energy battery charge", "daily_energy_batt_char", "kWh"),
        DeliosSensor(api, "12 Self Sufficiency", "daily_self_sufficiency", "%"),
        DeliosSensor(api, "13 Annual energy house", "annual_energy_house", "kWh"),
        DeliosSensor(api, "14 Annual energy taken", "annual_energy_grid_taken", "kWh"),
        DeliosSensor(api, "15 Annual energy given", "annual_energy_grid_given", "kWh"),
        DeliosSensor(api, "16 Annual energy PV", "annual_energy_pv", "kWh"),
        DeliosSensor(api, "17 Annual self sufficiency", "annual_self_sufficiency", "%"),
    ]
