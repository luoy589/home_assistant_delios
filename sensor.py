...
async def async_setup_platform(hass, config, add_entities, discovery_info=None):
    ...
    sensors = [
        DeliosSensor(api, "01 Battery SOC", "percent_batt", "%", "mdi:battery-high"),
        DeliosSensor(api, "02 Power House", "power_house", "kW", "mdi:home-lightning-bolt"),
        ...
        DeliosSensor(api, "10 Daily energy battery discharge", "daily_energy_batt_dischar", "kWh", "mdi:battery-arrow-down"),
        DeliosSensor(api, "11 Daily energy battery charge", "daily_energy_batt_char", "kWh", "mdi:battery-arrow-up"),
        DeliosSensor(api, "12 Self Sufficiency", "daily_self_sufficiency", "%", "mdi:leaf"),
        DeliosSensor(api, "13 Annual energy house", "annual_energy_house", "kWh", "mdi:home-lightning-bolt"),
        DeliosSensor(api, "14 Annual energy taken", "annual_energy_grid_taken", "kWh", "mdi:transmission-tower-export"),
        DeliosSensor(api, "15 Annual energy given", "annual_energy_grid_given", "kWh", "mdi:transmission-tower-import"),
        DeliosSensor(api, "16 Annual energy PV", "annual_energy_pv", "kWh", "mdi:solar-power"),
        DeliosSensor(api, "17 Annual self sufficiency", "annual_self_sufficiency", "%", "mdi:leaf"),
    ]
